...
/**
 * Entity implementation class for Entity: РасчетЗаказа
 */
@Entity(name = "IISProbachetyreРасчетЗаказа")
@Table(schema = "public", name = "РасчетЗаказа")
public class RaschetZakaza {
