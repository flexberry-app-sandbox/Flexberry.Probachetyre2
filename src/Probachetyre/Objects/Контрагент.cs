...
namespace IIS.Probachetyre
{
    ...
    public class Контрагент : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Probachetyre.Лица fЛицо;
        ...
        public virtual IIS.Probachetyre.Лица Лицо
        {
            get
            {
                ...
                IIS.Probachetyre.Лица result = this.fЛицо;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View КонтрагентE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("КонтрагентE", typeof(IIS.Probachetyre.Контрагент));
                }
            }
            ...
            public static ICSSoft.STORMNET.View КонтрагентL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("КонтрагентL", typeof(IIS.Probachetyre.Контрагент));
                }
            }
        }
    }
